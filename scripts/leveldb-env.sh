#!/usr/bin/env bash
# Shared setup for LevelDB YCSB runs.
...
LEVELDB_PROPS="${LEVELDB_PROPS:-${PROJECT_ROOT}/src/test/resources/ycsb/leveldb.properties}"
DB_CLASS="io.cascadestore.lsm.benchmark.ycsb.LevelDbShardedYcsbClient"
...
leveldb_ycsb_setup() {
  ...
  export YCSB_CP RESULTS_DIR LEVELDB_PROPS DB_CLASS YCSB_HOME PROJECT_ROOT
}
